...
Meetings of the ELN Special Interest Group are held on Thursdays at 3 PM, US Eastern Time. It is listed on the https://calendar.fedoraproject.org/SIGs/[SIGs calendar].
